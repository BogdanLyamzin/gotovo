        ...
        <>
            ...
            <section className="marriage-registration">
                <div className="marriage-registration-item">
                    <h2 className="marriage-registration-title underline">Реєстрація шлюбу без черг</h2>
                    <div className="marriage-registration-text">
                        <p>Кожній закоханій парі хочеться якнайшвидше потрапити у святая святих - місце, де будуть
                            узаконені їхні стосунки. Тільки ось величезний потік людей ніяк не дає можливості швидко
                            закінчити з довгими процедурами. Чи можна без черги зареєструвати шлюб?</p>
                        <br/>
            ...
            <section className="marriage-documents">
                <div className="container">
                    ...
                    <div className="marriage-documents-content">
                        <ol>
                            <li className="marriage-documents-tab selected underline">Державна реєстрація шлюбу між
                                громадянами України
                            </li>
                            <li className="marriage-documents-tab">Державна реєстрація шлюбу між чоловіком та жінкою,
                                які не є громадянами України (або один із них)
                            </li>
                            <li className="marriage-documents-tab">Проставлення апостиля</li>
                        </ol>
                        <ul>
                            <li className="marriage-documents-item">Паспорт громадянина України (при наданні id-картки
                                додатково подається додаток №13 «Довідка про реєстрацію місця проживання особи»)
                            </li>
                            <li className="marriage-documents-item">Ідентифікаційний код</li>
                            <li className="marriage-documents-item">Особи, в яких було вилучено паспорт громадянина
                                України, у зв'язку з взяттям на консульський облік в іншій державі, надають паспорт
                                громадянина України для виїзду за кордон з відповідною відміткою про це в паспорті
                            </li>
                            <li className="marriage-documents-item">Якщо особа раніше перебувала в шлюбі, то додатково
                                надається документ, що підтверджує припинення попереднього шлюбу або визнання шлюбу
                                недійсним (свідоцтво про розірвання шлюбу, видане на ім’я замовника; рішення суду про
                                розірвання шлюбу, про визнання шлюбу недійсним, яке набрало законної сили з відміткою;
                                свідоцтво про смерть одного з подружжя; висновок відділу державної реєстрації актів
                                цивільного стану про анулювання актового запису про шлюб, який є недійсним тощо).»
                                Деталі за телефоном: +38 096 056 44 44 (Viber, WhatsApp, Telegram)
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <section className="marriage-contacts">
                <div className="container marriage-contacts-content">
                    <div>
                        <h2 className="title marriage-contacts-label">Залиште заявку і отримаєте безкоштовну
                            консультацію</h2>
                        ...
                        <textarea placeholder="Ваше Повідомлення" name="" id="" cols="30" rows="10"
                                  className="marriage-contacts-input"></textarea>
                        <a href="#" className="btn _dark _long marriage-contacts-btn">Отримати
                            консультацiю</a>
                    </div>
                    <div>
                ...
                <span className="contacts-icon">
                    <img src="/img/Contacts/item-1.png" alt="contact icon"/>
                        ...
                        <iframe className="marriage-contacts-map"
